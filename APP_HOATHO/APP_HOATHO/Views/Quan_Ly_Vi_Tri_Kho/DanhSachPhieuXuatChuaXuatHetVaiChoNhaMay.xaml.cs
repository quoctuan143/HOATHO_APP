...
namespace APP_HOATHO.Views.Quan_Ly_Vi_Tri_Kho
{
    ...
    public partial class DanhSachPhieuXuatChuaXuatHetVaiChoNhaMay : ContentPage
    {
        ...
        private void btnbutru_Tapped(object sender, System.EventArgs e)
        {
            viewModel.BuTruCommand.Execute(null);
        }

        private void btnGhiNo_Tapped(object sender, System.EventArgs e)
        {
