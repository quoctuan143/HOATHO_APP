...
namespace APP_HOATHO.Views.Quan_Ly_Vi_Tri_Kho
{
    ...
    public partial class DanhSachPhieuXuatKhoChiTiet_Page : ContentPage
    {
        private DanhSachPhieuXuatKhoChiTiet_ViewModel viewModel;

        public DanhSachPhieuXuatKhoChiTiet_Page(string sochungtu)
        {
            InitializeComponent();
            viewModel = new DanhSachPhieuXuatKhoChiTiet_ViewModel(sochungtu);
