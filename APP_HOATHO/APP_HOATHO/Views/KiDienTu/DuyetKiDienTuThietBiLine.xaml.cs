...
namespace APP_HOATHO.Views.KiDienTu 
{
    ...
    public partial class DuyetKiDienTuThietBiLine : ContentPage
    {
        DuyetKiDienTuThietBi_Line_ViewModel viewModel;
       
        public DuyetKiDienTuThietBiLine(DuyetKiDienTuPhuTungModel item, DocumentType type) 
        {
            InitializeComponent();
            
            viewModel = new DuyetKiDienTuThietBi_Line_ViewModel(item, type);
