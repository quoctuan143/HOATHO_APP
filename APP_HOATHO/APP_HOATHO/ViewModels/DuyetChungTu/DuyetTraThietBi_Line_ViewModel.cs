...
{
   public class DuyetTraThietBi_Line_ViewModel : BaseViewModel 
    {
        #region "Field"
        ...
        public DuyetTraThietBi_Line_ViewModel(DuyetKiDienTuPhuTungModel duyetChungTuModel, DocumentType type) 
        {
            this.DuyetChungTuModel = duyetChungTuModel;
            this._documentType = type;            
            Title = "Chi tiết trả thiết bị";           
        ...
        private async void OnDeleteClick(object obj)
        {
            ...
            if (isDelete == DialogReturn.OK )
            {
                ...
                {                   
                    ...
                    ok = await Config.client.PostAsJsonAsync("api/DuyetChungTu/DuyetTraThietBi", DuyetChungTuModel);
        ...
        private async void OnLoadExcute(object obj)
        {
            try
            {
                ...
                await Task.Delay(1000);
                string url = $"api/DuyetChungTu/geDuyetTraThietBi_ChiTiet?documentno={DuyetChungTuModel.No_}";
