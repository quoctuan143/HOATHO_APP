...
{
   public class DuyetTraThietBi_ViewModel : BaseViewModel
    {
        #region "Field"
        ...
        public DuyetTraThietBi_ViewModel(DocumentType type)
        {
            this._documentType = type;
            Title = "DUYỆT TRẢ THIẾT BỊ";
            ...
            MessagingCenter.Subscribe<DuyetTraThietBi_Line_ViewModel, string>(this, "DuyetChungTu", (sender, docno) =>
            {
        ...
        private async void OnLoadExcute(object obj)
        {
            try
            {
                ...
                ListItem.Clear();
                var _json = Config.client.GetStringAsync(Config.URL + $"api/DuyetChungTu/geDuyetTraThietBi?username={Preferences.Get(Config.User, "")}").Result;
