...
{
   public class DuyetKiDienTuPhuTung_Line_ViewModel : BaseViewModel 
    {
        #region "Field"
        ...
        public DuyetKiDienTuPhuTung_Line_ViewModel(DuyetKiDienTuPhuTungModel duyetChungTuModel, DocumentType type) 
        {
            this.DuyetChungTuModel = duyetChungTuModel;
            this._documentType = type;            
            Title = "Chi tiết xuất phụ tùng";           
        ...
        private async void OnDeleteClick(object obj)
        {
            ...
            if (isDelete == DialogReturn.OK )
            {
                ...
                {                   
                    ...
                    ok = await Config.client.PostAsJsonAsync("api/DuyetChungTu/DuyetKiDienTuPhuTung", DuyetChungTuModel);
        ...
        private async void OnLoadExcute(object obj)
        {
            try
            {
                ...
                await Task.Delay(1000);
                string url = $"api/DuyetChungTu/getKiDienTuPhuTung_ChiTiet?documentno={DuyetChungTuModel.No_}";
                ...
                if (respon.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    if (_json.Contains("[]") == false)
                    {
                        ...
                        ListItem = JsonConvert.DeserializeObject<ObservableCollection<DuyetKiDienTuPhuTungModel_Line>>(result);
                    }
                }
