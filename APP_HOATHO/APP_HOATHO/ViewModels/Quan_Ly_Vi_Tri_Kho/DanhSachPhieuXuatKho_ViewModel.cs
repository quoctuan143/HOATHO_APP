...
{
    public class DanhSachPhieuXuatKho_ViewModel : BaseViewModel
    {
        ...
        public DanhSachPhieuXuatKho_ViewModel()
        {
        ...
        protected override async void OnAppearing()
        {
            try
            {
                ...
                string url = $"api/qltb/GetThongTinPhieuXuatKho?fromdate={string.Format("{0:yyyy-MM-dd}", FromDate)}&todate={string.Format("{0:yyyy-MM-dd}", ToDate)}";
                ListItem.Clear();
